...
- **Budget** – ramme, hvad det koster, hvad der er betalt, buffer; donut over hvad der fylder mest; poster med forventet pris, endelig pris (bruges når den er udfyldt), ✓ betalt, hvem ordner det, note; pris pr. gæst (👥) følger gæsteantallet, som automatisk følger gæstelisten (ja + afventer) – kan slås fra og sættes manuelt
- **Gæster** – navn, side, køn (gættes ud fra fornavnet, kan rettes), relation, svar (ja/afventer/nej), barn, kost/allergi; filtre (også **Børn**), søgning, "tilføj flere ad gangen"; **Med børn / Uden børn** – én knap slår børnene fra i alle tal (gæsteantal, pris pr. gæst, bordplan, kost-liste), mens I venter på at beslutte det. Ingen gæster slettes eller flyttes: børnene bliver stående på listen og i bordplanen, blot tonet ned og ikke talt med. Valget deles mellem jer som resten af planen
- **Plantegning & bordplan** – tegn festlokalet: rum (med mål i meter, 1 m = 50 px), områder (dansegulv, lounge, bar, DJ, buffet, kagebord…), døre og åbninger i væggene, langborde (pladser på begge sider, evt. bordender) og runde borde (loungeborde kan undtages fra bordplanen); træk alt rundt og træk i hjørnet for at ændre størrelse; zoom; navnene står inde på langbordene ud for hvert sæde og skråt ud fra runde borde; langborde kan lægges vandret; **fortryd/gentag** med knapper oppe i hjørnet af tegningen (og ⌘Z / ⇧⌘Z) – dækker flyt, størrelse, tilføj, slet, ryd og hvem der sidder hvor, så en fejl på iPad uden tastatur kan rulles tilbage; **fokuseret bordplan** (knap øverst) viser kun bordene, pladserne og navnene – rum, områder, døre og loungeborde er skjult, og intet kan flyttes ved et uheld (træk ruller kun); den huskes pr. enhed og printes som den ses; gem bordplanen som navngivne versioner og hent dem igen (prøv flere opstillinger); klik eller træk gæster på plads; **Med børn / Uden børn** virker også her – børn forsvinder fra «Ikke placeret», deres plads tones ned, og alle tællere, bordkort og kost-listen følger med; print plantegning/bordkort (tre størrelser); kost-liste til kokken
...
Søg på tværs af alt med ⌘K / luppen øverst. Alt gemmes automatisk; sletning kan fortrydes; JSON-eksport/-import; tre temaer (lyst, rosa og mørkt – knappen øverst til højre skifter, og uden et valg følger siden systemet); fungerer på mobil.
