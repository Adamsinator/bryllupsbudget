...
- **Plantegning & bordplan** – tegn festlokalet: rum (med mål i meter, 1 m = 50 px), områder (dansegulv, lounge, bar, DJ, buffet, kagebord…), døre og åbninger i væggene, langborde (pladser på begge sider, evt. bordender) og runde borde (loungeborde kan undtages fra bordplanen); træk alt rundt og træk i hjørnet for at ændre størrelse; zoom; navnene står inde på langbordene ud for hvert sæde og skråt ud fra runde borde; langborde kan lægges vandret; fortryd (⌘Z) for flyt/størrelse; gem bordplanen som navngivne versioner og hent dem igen (prøv flere opstillinger); klik eller træk gæster på plads; print plantegning/bordkort (tre størrelser); kost-liste til kokken
